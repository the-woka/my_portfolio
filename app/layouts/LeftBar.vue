<template>
    <div class="hidden md:flex fixed top-0 left-0 items-center h-screen pl-9 z-20 bg-(--bg-primary-color) animate-fade-in-left">
        <div class="flex flex-col align-center gap-4">
            ...
            <a href="https://www.linkedin.com/in/adrian-yoris-mbake-woka/" rel="noopener noreferrer" target="_blank" class="text-xl text-(--text-tertiary-color) transition-transform duration-200 ease-out hover:-translate-y-1 hover:text-(--tertiary-color)" title="LinkedIn"><Icon name="meteor-icons:linkedin" /></a>
        </div>
    </div>
</template>
